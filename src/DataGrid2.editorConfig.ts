...
import { ColumnsPreviewType, DataGrid2PreviewProps } from "../typings/DataGrid2Props";

export function getProperties(
    values: DataGrid2PreviewProps,
...
export const getPreview = (values: DataGrid2PreviewProps, isDarkMode: boolean): StructurePreviewProps => {
...
export function check(values: DataGrid2PreviewProps): Problem[] {
